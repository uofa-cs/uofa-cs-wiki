...
- City, Province (Edmonton, AB is fine; no need for your full street address)
...
- **Cloud/Infrastructure:** AWS (S3, EC2, Lambda), GCP, Azure (only if you've actually used them)
