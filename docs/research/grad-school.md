...
A PhD makes sense if:
- You want to be a faculty member at a university
- You want to work at a research lab (DeepMind, MSR, AI2, FAIR, etc.) in a research scientist capacity
- You genuinely love the process of pushing knowledge forward and would do it regardless of the career outcome

A PhD is not a good choice if:
- You don't know what you want to do and are delaying the decision
- You want to be a software engineer and think a PhD will open more doors (it often doesn't, and can actually signal overqualification for many roles)
- You're doing it for prestige — the opportunity cost is enormous and the prestige doesn't cash out the way you might think
